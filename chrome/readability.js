...
// Notice: Modified by Jim Kang.

// From http://arc90labs-readability.googlecode.com/svn/trunk/js/readability.js

// Hacked up a bit to get it to return content and not do so much with putting
// the content on the DOM.
...
var readability = {
    ...
    **/
    ...
    /***
     * grabArticleAsTextArray - Using a variety of metrics (content score, classname, element types), find the content that is
    ...
    **/
    grabArticleAsTextArray: function grabArticleAsTextArray(page) {        
        ...
        **/
        var totalLength = textGroups.reduce(readability.addLengthOfString, 0);
        ...
        if (totalLength < 250) {
            ...
            if (readability.flagIsActive(readability.FLAG_STRIP_UNLIKELYS)) {
                ...
                return readability.grabArticleAsTextArray(page);
            }
    ...
    addLengthOfString: function addLengthOfString(previousLength, str) {
        return previousLength + str.length;
    },
